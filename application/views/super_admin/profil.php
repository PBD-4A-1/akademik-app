	...
	<div class="card mx-2 mt-2">
		...
		<div class="card-body">
			<form method="POST" action="">
                ...
                <button type="submit" class="btn input btn-primary pull-right float-md-right mt-2" id="edit" name="edit">Simpan Profil</button>
                <button href="<?= base_url(); ?>super_admin" class="btn btn-outline-secondary pull-right float-md-right mt-2 mr-2">Batal</button>
