...
<div class="container-fluid">
	...
	<div class="card shadow mb-4">
		...
		<div class="card-body">
			...
			<a href="<?= base_url(); ?>admin/prodi" class="btn btn-primary float-right">Kembali</a>
			<a href="<?= base_url(); ?>admin/hapus/<?= $akademik['idprodi']; ?>" onclick="return" class="btn btn-outline-danger mr-2 float-right">Hapus</a>
		</div>
	</div>
